...
const content = fs.readFileSync(path.join(__dirname, 'views', 'index.html'), 'utf8');
...
console.log(`Found ${scripts.length} embedded javascript scripts in views/index.html.`);

// Let's filter lines in the scripts containing key words
const keywords = ['signup', 'login', 'visitor', 'payment', 'checkout', 'has_access', 'verify-haraka', 'verify-zeno', 'ADMIN_PIN'];
